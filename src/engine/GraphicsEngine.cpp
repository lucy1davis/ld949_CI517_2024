...
//THIS IS WHERE I CAN CHANGE THE FONT
...
// SPRITES WILL BE DISPLAYED AS TEXTURES
...
// CHARACTER BUBBLES ABOVE TEXT BOX??
...
{
	//doesnt like this for some reason starts saying list is empty
	if (!textList.empty())
	{
